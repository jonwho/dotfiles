...
au BufRead,BufNewFile *.{c,h,java,hpp,cpp,rb,py,erb,js,coffee,html} set expandtab
au BufRead,BufNewFile *.{c,h,java,hpp,cpp,rb,py,erb,js,coffee,html} set shiftwidth=2
au BufRead,BufNewFile *.{c,h,java,hpp,cpp,rb,py,erb,js,coffee,html} set tabstop=2
